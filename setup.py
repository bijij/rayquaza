...
extras_require = {
    "docs": extras_require_docs,  # TODO: rayquaza[docs]
    # "test": extras_require_test,  # TODO: rayquaza[test]
}
...
setuptools.setup(
    ...
    description="An asynchronous python mediator library.",
    ...
    url="https://github.com/bijij/rayquaza",
    version=version,
)
